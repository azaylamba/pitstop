...
You have to design & build the backend for the application and the ability for the users to register and book car services.
...
https://github.com/azaylamba/pitstop 
